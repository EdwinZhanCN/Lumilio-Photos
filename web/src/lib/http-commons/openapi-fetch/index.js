...
export default function createClient(clientOptions) {
   ...
   * @param {T} url
   * @param {import('../index.ts').FetchOptions<T>} fetchOptions
   */
 ...
 * @type {import("../index.ts").wrapAsPathBasedClient}
 */
 ...
 * @type {import("../index.ts").createPathBasedClient}
 */
 ...
 * @type {import("../index.ts").serializePrimitiveParam}
 */
 ...
 * @type {import("../index.ts").serializeObjectParam}
 */
 ...
 * @type {import("../index.ts").serializeArrayParam}
 */
 ...
 * @type {import("../index.ts").createQuerySerializer}
 */
 ...
 * @type {import("../index.ts").defaultPathSerializer}
 ...
 * @type {import("../index.ts").defaultBodySerializer}
 */
 ...
 * @type {import("../index.ts").createFinalURL}
 */
 ...
 * @type {import("../index.ts").mergeHeaders}
 */
 ...
 * @type {import("../index.ts").removeTrailingSlash}
 */
