...
export type UploadPrecheckFile = Schemas["dto.UploadPrecheckFileDTO"];
export type UploadPrecheckResponse = Schemas["dto.UploadPrecheckResponseDTO"];
export type UploadPrecheckResult = Schemas["dto.UploadPrecheckResultDTO"];
