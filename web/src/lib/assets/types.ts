...
export type MediaItemDTO = Schemas["dto.MediaItemDTO"];
export type MediaItemComponentDTO = Schemas["dto.MediaItemComponentDTO"];
export type MediaItemByAssetResponse = Schemas["dto.MediaItemByAssetResponseDTO"];
