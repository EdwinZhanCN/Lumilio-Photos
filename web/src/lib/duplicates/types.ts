...
export type ListDuplicateGroupsResponse =
  Schemas["dto.ListDuplicateGroupsResponseDTO"];
export type DetectDuplicatesRequest =
  Schemas["dto.DetectDuplicatesRequestDTO"];
export type DetectDuplicatesResponse =
  Schemas["dto.DetectDuplicatesResponseDTO"];
export type MergeDuplicateGroupRequest =
  Schemas["dto.MergeDuplicateGroupRequestDTO"];
export type MergeDuplicateGroupResponse =
  Schemas["dto.MergeDuplicateGroupResponseDTO"];
export type MergeDuplicatePolicy =
  Schemas["dto.MergeDuplicatePolicyDTO"];
