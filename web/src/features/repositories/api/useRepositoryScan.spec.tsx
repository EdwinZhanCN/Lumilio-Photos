...
import { useRepositoryScan } from "./useRepositoryScan";
...
describe("Repository scan operation", () => {
  it("settles the mutation from the durable enqueue receipt without polling for completion", async () => {
    ...
    worker.use(
      http.post("*/api/v1/storage/repositories/:id/verifications", () =>
        HttpResponse.json({
      ...
      http.get("*/api/v1/storage/repositories/:id/verifications/latest", () => {
        latestRequests += 1;
