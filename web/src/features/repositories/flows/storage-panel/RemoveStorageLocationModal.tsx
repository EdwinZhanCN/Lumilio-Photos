    ...
    <div className="modal modal-open z-modal">
      <div className="modal-box max-w-md">
        ...
        <div className="mt-4 space-y-1 rounded-lg border border-base-300 bg-base-200/40 px-3 py-2 text-xs text-base-content/65">
          ...
          {/* A Storage Location owns registration, never capacity: the figure
              belongs to the Repositories measured on it. */}
          <div>
            {t("manage.repositories.storageLocationRepositoryCount", "{{count}} Repositories", {
