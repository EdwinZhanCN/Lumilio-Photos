...
export default function RemoveRepositoryModal({
  ...
  const impactMutation = $api.useMutation(
    "post",
    "/api/v1/storage/repositories/{id}/detach-impact",
  );
  const [impact, setImpact] = useState<
    components["schemas"]["dto.RepositoryRemovalImpactDTO"] | undefined
  >(undefined);
  ...
  useEffect(() => {
    ...
    setImpactError(false);
    void impactMutation
      .mutateAsync({ params: { path: { id: repository.id } } })
      .then((data) => {
        ...
        <form className="mt-5" onSubmit={handleSubmit}>
          ...
          <div className="modal-action">
            ...
            <button
              ...
              disabled={!confirmed || impactLoading || impactError || removal.isPending}
            >
