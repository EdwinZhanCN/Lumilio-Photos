...
export default function FilterTool({
  ...
  return (
    <div className={`dropdown dropdown-end isolate ${open ? "dropdown-open" : ""}`} ref={rootRef}>
      <button
        type="button"
      ...
      {open && (
        <div className="dropdown-content bg-base-100 rounded-box z-10 w-80 max-w-[calc(100vw-2rem)] p-0 shadow-xl border border-base-200 mt-2 overflow-hidden flex flex-col">
