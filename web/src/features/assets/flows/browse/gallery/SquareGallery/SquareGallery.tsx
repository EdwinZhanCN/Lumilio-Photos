...
import { DEFAULT_GROUP_KEYS, formatAssetGroupLabel } from "../../../../model/assetGroups";
import EmptyState from "@/components/ui/EmptyState";
import { getBrowseItemAsset } from "../../../../model/browseItems";
import type { BrowseItem } from "../../../../types";
import { useGalleryInfiniteScroll } from "../useGalleryInfiniteScroll";
import { intersectsGalleryWindow, useGalleryViewportWindow } from "../useGalleryViewportWindow";
...
type VirtualSquareGridProps = {
  ...
  render3DCard: boolean;
  renderTileCaption?: (asset: Asset, index: number, groupKey: string) => React.ReactNode;
  selection: ReturnType<typeof useSelectionKeyboard>;
...
const SquareGallery: React.FC<SquareGalleryProps> = ({
  ...
  const selection = useSelectionKeyboard(flatAssetIds);
