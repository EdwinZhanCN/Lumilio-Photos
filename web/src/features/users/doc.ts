 ...
 * ## State
 *
 * {@link useUsers} keeps the normalized {@link ManagedUserDTO} list in TanStack
 ...
 * ```
 *
 * {@link useUpdateMyProfile} updates the current profile.
 * {@link useAdminUpdateUser} and {@link useResetUserAccess} support
 * administrator flows. {@link useChangeMyPassword} is consumed by the Auth
