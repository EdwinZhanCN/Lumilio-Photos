...
import { formatRelativeTime, type RecentEditRecord } from "../../state/recentEdits";
...
export function RecentEditItem({ item, onResume }: RecentEditItemProps): React.JSX.Element {
  ...
  return (
    <div className="group flex items-center gap-3 rounded-lg border border-base-300 bg-base-100 p-2 pr-3 transition-all hover:border-base-content/20 hover:shadow-sm focus-within:ring-1 focus-within:ring-primary/50">
      <PhotoThumb assetId={item.assetId} alt={item.name} className="h-12 w-12 shrink-0" />
