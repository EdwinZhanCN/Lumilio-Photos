 ...
 *
 * The `?url` imports are static so the bundler can fingerprint and emit each
 * face. This module is only ever reached through a dynamic import (see
...
import jakarta300 from "@fontsource/plus-jakarta-sans/files/plus-jakarta-sans-latin-300-normal.woff2?url";
...
import jakarta700i from "@fontsource/plus-jakarta-sans/files/plus-jakarta-sans-latin-700-italic.woff2?url";
...
import playfair400i from "@fontsource/playfair-display/files/playfair-display-latin-400-italic.woff2?url";
...
import spaceMono400i from "@fontsource/space-mono/files/space-mono-latin-400-italic.woff2?url";
...
import notoSc400 from "@fontsource/noto-sans-sc/files/noto-sans-sc-chinese-simplified-400-normal.woff2?url";
import notoSc700 from "@fontsource/noto-sans-sc/files/noto-sans-sc-chinese-simplified-700-normal.woff2?url";
import notoSc900 from "@fontsource/noto-sans-sc/files/noto-sans-sc-chinese-simplified-900-normal.woff2?url";
