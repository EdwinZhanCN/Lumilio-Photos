 ...
 * @returns {Uint8Array}
 */
export function generate_thumbnail(buffer, max_size) {
...
export class ThumbnailResult {
     ...
     */
    get data() {
        const ret = wasm.thumbnailresult_data(this.__wbg_ptr);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('thumbnail_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
