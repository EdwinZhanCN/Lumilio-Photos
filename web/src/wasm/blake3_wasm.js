...
export function hash_asset(buffer) {
    ...
    return HashResult.__wrap(ret[0]);
}
...
export function compare_assets(buffer1, buffer2) {
    const ptr0 = passArray8ToWasm0(buffer1, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(buffer2, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.compare_assets(ptr0, len0, ptr1, len1);
    return ret !== 0;
}
 ...
 * @returns {HashResult}
 */
export function from_hash_string(hash_string) {
    const ptr0 = passStringToWasm0(hash_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.from_hash_string(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return HashResult.__wrap(ret[0]);
...
export function verify_asset_hash(buffer, hash_string) {
    const ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(hash_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
export class HashResult {
    ...
    get hash() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.hashresult_hash(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     * @param {string} hash_string
     */
    constructor(hash_string) {
        const ptr0 = passStringToWasm0(hash_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hashresult_new(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        HashResultFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
