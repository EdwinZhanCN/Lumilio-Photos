var createExiv2Module = (() => {
    ...
    return async function (moduleArg = {}) {
        ...
        var __emval_create_invoker = (argCount, argTypesPtr, kind) => {
            ...
            var [retType, ...argTypes] = emval_lookupTypes(
                argCount,
                argTypesPtr,
            );
            ...
            switch (kind) {
                ...
                case 1:
                    ...
                    functionBody =
                        "toValue(handle)[getStringOrSymbol(methodName)]";
                    break;
            }
            functionBody += `(${args})`;
            if (!retType.isVoid) {
        ...
        var _malloc, _free, ___getTypeName, _emscripten_builtin_memalign;
        function assignWasmExports(wasmExports) {
            _malloc = wasmExports["Q"];
            _free = wasmExports["R"];
            ___getTypeName = wasmExports["S"];
