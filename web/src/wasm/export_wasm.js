 ...
 * @returns {Array<any>}
 */
export function get_supported_formats() {
    const ret = wasm.get_supported_formats();
    return ret;
}
 ...
 * @returns {boolean}
 */
export function validate_export_options(options_js) {
    const ret = wasm.validate_export_options(options_js);
    return ret !== 0;
}
...
export class ImageProcessor {
    ...
    load_from_bytes(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.imageprocessor_load_from_bytes(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     */
    get_dimensions() {
        const ret = wasm.imageprocessor_get_dimensions(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {any}
     */
    export_image(options_js) {
        const ret = wasm.imageprocessor_export_image(this.__wbg_ptr, options_js);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('export_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
