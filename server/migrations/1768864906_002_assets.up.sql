...
CREATE TABLE embeddings (
    ...
    embedding_type VARCHAR(50) NOT NULL,      -- 'clip', 'face', 'bioclip', 'custom'
    embedding_model VARCHAR(100) NOT NULL,    -- 'openai-clip-vit-base-patch32', 'facenet-v1', etc.
    embedding_dimensions INTEGER NOT NULL,    -- 512, 128, 768, 1024, etc.
    vector VECTOR(1024),                      -- Support up to 1024 dimensions
    is_primary BOOLEAN DEFAULT FALSE,         -- Mark preferred model for each type
