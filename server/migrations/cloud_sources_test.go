...
func TestRepositoryCloudBindingsAllowMultipleScopedSources(t *testing.T) {
	...
	const storageLocationID = "00000000-0000-0000-0000-000000000001"
	...
	if _, err := database.ExecContext(ctx, `
		...
		INSERT INTO repositories (repo_id, name, path, created_at, updated_at, storage_location_id)
	...
	`, storageLocationID, repositoryID, storageLocationID, firstCredential, secondCredential); err != nil {
		t.Fatal(err)
	}
	if _, err := database.ExecContext(ctx, `
