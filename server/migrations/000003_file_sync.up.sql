-- File synchronization tracking migration (up)
-- Creates tables to track file changes and sync operations

-- File records table - tracks all files in user-managed areas
...
-- Sync operations table - tracks sync runs for monitoring
