...
func TestExpandedEmbeddingKNNLimitRespectsVec1WorkBound(t *testing.T) {
	cases := map[int]int{
		0:                           1,
		1:                           embeddingKNNExpansion,
		maxANNAssetCandidateSet:     maxVec1KNNVectors,
		maxANNAssetCandidateSet + 1: maxVec1KNNVectors,
		100_000:                     maxVec1KNNVectors,
	}
