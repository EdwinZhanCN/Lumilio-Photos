...
type Tag struct {
	...
	Assets []Asset `gorm:"many2many:asset_tags;foreignKey:TagID;joinForeignKey:TagID;References:AssetID;joinReferences:AssetID" json:"assets,omitempty"`
}
...
type AssetTag struct {
	...
	Confidence float32   `gorm:"type:numeric(4,3);check:confidence >= 0 AND confidence <= 1" json:"confidence" example:"0.95"`
	Source     string    `gorm:"type:varchar(20);default:'system';check:source IN ('system', 'user', 'ai')" json:"source" example:"ai" enums:"system,user,ai"`
}
