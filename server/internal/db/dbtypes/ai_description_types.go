...
// AIDescriptionMeta 用于在 PhotoSpecificMetadata 中缓存 AI 描述信息
type AIDescriptionMeta struct {
...
// AIDescriptionStats 表示 AI 描述处理的统计信息
type AIDescriptionStats struct {
...
// AIDescriptionRequest 表示 AI 描述生成请求
...
// AIDescriptionResponse 表示 AI 描述生成响应
...
// AIDescriptionFilter 用于描述搜索的过滤器
type AIDescriptionFilter struct {
...
// Validate 验证过滤器参数
func (f *AIDescriptionFilter) Validate() error {
