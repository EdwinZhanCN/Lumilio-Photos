...
type BrowserCapabilitiesDTO struct {
	...
	PasskeyUnavailableReason string `json:"passkey_unavailable_reason,omitempty" enums:"disabled,secure_origin_required,domain_required,invalid_request_origin"`
