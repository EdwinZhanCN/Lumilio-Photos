...
// GetSetupStatus reports whether the system configuration payload exists on disk.
...
// password, persists the secret with locked-down permissions, and records
...
// @Accept json
// @Produce json
// @Param request body dto.SetupRequestDTO true "Setup payload"
