...
func TestAssetHandlerQueryAssets_StackModeCollapsed_ReturnsBrowseRowsAndLegacyRepresentatives(t *testing.T) {
	...
	require.NotNil(t, response.Data.Assets[0].Stack)
	require.Equal(t, stackID.String(), response.Data.Assets[0].Stack.StackID)
	require.True(t, response.Data.Assets[0].Stack.StackCover)
	require.NotNil(t, response.Data.Assets[0].Stack.StackSize)
	require.Equal(t, 2, *response.Data.Assets[0].Stack.StackSize)
...
func TestAssetHandlerQueryAssets_StackModeExpanded_AssetBrowseItemsConsistentTotals(t *testing.T) {
	...
	require.Len(t, response.Data.Assets, 2)
	require.NotNil(t, response.Data.TotalVisible)
...
func TestAssetHandlerSearchAssets_StackModeCollapsed_ReturnsBrowseRowsAndLegacyRepresentatives(t *testing.T) {
	...
	require.Equal(t, coverUUID.String(), response.Data.TopResults[0].AssetID)
	require.NotNil(t, response.Data.TopResults[0].Stack)
	require.Equal(t, stackID.String(), response.Data.TopResults[0].Stack.StackID)
	require.True(t, response.Data.TopResults[0].Stack.StackCover)
	require.NotNil(t, response.Data.TopResults[0].Stack.StackSize)
	require.Equal(t, 2, *response.Data.TopResults[0].Stack.StackSize)

	require.Len(t, response.Data.ResultItems, 1)
	require.Len(t, response.Data.Results, 1)
	require.Equal(t, coverUUID.String(), response.Data.Results[0].AssetID)
	require.NotNil(t, response.Data.Results[0].Stack)
	require.Equal(t, stackID.String(), response.Data.Results[0].Stack.StackID)
	require.True(t, response.Data.Results[0].Stack.StackCover)
	require.NotNil(t, response.Data.Results[0].Stack.StackSize)
	require.Equal(t, 2, *response.Data.Results[0].Stack.StackSize)
