...
Cancelling, stopping generation, or closing the page never commits interrupted changes. Do not treat natural-language text in a model reply as proof of success; the final authority is the page result and the actual state in the repository — see the [effect receipt](../features/agent#step-4-the-effect-receipt-is-authoritative).
