...
// WriteAtomic writes one private metadata file with a durable replace. It
// refuses to replace a symlink so an app-data path cannot redirect writes out
// of the private state root.
