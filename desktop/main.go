...
// app. It runs the existing Go API server and its private SQLite catalog
// in-process (see the supervisor package), while the React UI is served over
// HTTP and opened in the user's browser.
package main
